...
public class CsvTsvParser : MonoBehaviour
{
    ...
    void Start()
    {
        // var dataFile = Resources.Load<TextAsset>("CsvData"); // Csv File Parsing
        
        var dataFile = Resources.Load<TextAsset>("TsvData"); // Tsv File Parsing
    ...
    private void ParsingCharacterData(string data)
    {
        ...
        {
            // string[] cols = rows[i].Split(','); // Csv File Parsing
            
            string[] cols = rows[i].Split('\t'); // Tsv File Parsing
